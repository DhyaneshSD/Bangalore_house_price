...
function onPageLoad() {
    ...
    // Use this URL if you are using nginx
    ...
    $.get(url, function(data, status) {
        ...
        if (data && Array.isArray(data) && data.length > 0 && data[0].locations) {
        ...
        console.error("Failed to retrieve location names from the server");
